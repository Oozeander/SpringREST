...
public class PersistenceConfig {
	...
	private Properties jpaProperties() {
		...
		jpaProperties.putAll(Map.of(Environment.DIALECT, env.getRequiredProperty("db.dialect"),
				Environment.HBM2DDL_AUTO, env.getRequiredProperty("db.hbm2ddl_auto"), Environment.SHOW_SQL,
				env.getRequiredProperty("db.show_sql"), Environment.FORMAT_SQL,
				env.getRequiredProperty("db.format_sql"), Environment.ENABLE_LAZY_LOAD_NO_TRANS,
				env.getRequiredProperty("db.enable_lazy_load_no_trans")));
